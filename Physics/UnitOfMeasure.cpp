...
const string King::UnitOfMeasure::LinearMotion::_unit = "kg m/s"s;
...
const wstring King::UnitOfMeasure::LinearMotion::_wunit = L"kg m/s";
...
******************************************************************************/
// streams
std::ostream& King::UnitOfMeasure::operator<< (std::ostream& os, const King::UnitOfMeasure::LinearMotion& in)
{
    return os << "{ LinearMotion " << in._value << " " << in.Unit() << " }"; // text out
}
std::wostream& King::UnitOfMeasure::operator<< (std::wostream& os, const King::UnitOfMeasure::LinearMotion& in)
{
    return os << L"{ LinearMotion " << in._value << L" " << in.UnitW() << L" }"; // text out
}
std::istream& King::UnitOfMeasure::operator>> (std::istream& is, King::UnitOfMeasure::LinearMotion& out)
{
    return is >> out._value; // binary in
}
std::wistream& King::UnitOfMeasure::operator>> (std::wistream& is, King::UnitOfMeasure::LinearMotion& out)
{
    return is >> out._value; // binary in
}
// json
void King::UnitOfMeasure::to_json(json& j, const King::UnitOfMeasure::LinearMotion& from) { j = json{ {"LinearMotion", from._value}, {"U", from._unit} }; }
void King::UnitOfMeasure::from_json(const json& j, King::UnitOfMeasure::LinearMotion& to) { j.at("LinearMotion").get_to(to._value); }
// operators
UnitOfMeasure::LinearMotion King::UnitOfMeasure::operator*(const UnitOfMeasure::Speed& v, const UnitOfMeasure::Mass& m)
{
    return UnitOfMeasure::LinearMotion(static_cast<float>(v) * static_cast<float>(m));
}

UnitOfMeasure::LinearMotion King::UnitOfMeasure::operator*(const UnitOfMeasure::Mass& m, const UnitOfMeasure::Speed& v)
{
    return UnitOfMeasure::LinearMotion(static_cast<float>(v) * static_cast<float>(m));
}
UnitOfMeasure::LinearMotion King::UnitOfMeasure::operator*(const UnitOfMeasure::Strength& s, const UnitOfMeasure::Time& dt)
{
    return UnitOfMeasure::LinearMotion(static_cast<float>(s) * static_cast<float>(dt));
}
UnitOfMeasure::LinearMotion King::UnitOfMeasure::operator*(const UnitOfMeasure::Time& dt, const UnitOfMeasure::Strength& s)
{
    return UnitOfMeasure::LinearMotion(static_cast<float>(s) * static_cast<float>(dt));
}
/******************************************************************************
